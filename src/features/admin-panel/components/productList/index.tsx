...
import ActionButtons from '../../../../shared/components/GroupButtons'
import Button from '@/shared/components/button'
import { BiPlus } from 'react-icons/bi'
import { useState } from 'react'
import ProductManagementForm from '../productManagementForm'
import Modal from '@/shared/components/Modal'
import { TModelProduct } from '../../action/productActoin'
...
const ProductList = ({ list, className }: TProductListProps) => {
